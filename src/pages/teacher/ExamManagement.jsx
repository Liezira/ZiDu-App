...
// Token generator menggunakan Web Crypto API (cryptographically secure)
// Menggantikan Math.random() yang predictable dan bisa di-brute force
const generateToken = () => {
  const chars = 'ABCDEFGHJKLMNPQRSTUVWXYZ23456789'; // Tanpa karakter ambigu (0,O,I,1)
