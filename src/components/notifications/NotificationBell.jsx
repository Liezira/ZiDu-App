...
const NotificationBell = ({
  ...
  // Close on outside click (desktop only — mobile has explicit X)
  useEffect(() => {
    if (isMobile) return;
    const handler = (e) => {
      if (
  ...
  // ── Panel style: mobile = full-screen overlay, desktop = dropdown ──
        ...
        <>
          ...
          {isMobile && (
            <div
              ...
              style={{ position: 'fixed', inset: 0, background: 'rgba(15,23,42,.4)', zIndex: 8999, backdropFilter: 'blur(2px)' }}
            />
          )}
          ...
          <div ref={panelRef} style={panelStyle}>
            ...
            <div
              ...
              style={{
                flex: 1,
                overflowY: 'auto',
                // On mobile clamp height; on desktop absolute limit
